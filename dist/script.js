...
var calc = function calc(size, material, option, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value == '' || materialBlock.value == '') {
      resultBlock.textContent = "Пожалуйста, выберите и материал картины";
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var formData = new FormData(item); //перемен. для динамич. формир. пути отправки
...
var modals = function modals() {
  ...
  bindModals('.pulse', '.popup-gift', '.popup-gift .popup-close', true);
  showModalByScroll('.pulse');
